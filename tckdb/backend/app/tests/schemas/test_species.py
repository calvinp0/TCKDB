...
DATA_PATH = os.path.join(
    tckdb_path, "tckdb", "backend", "app", "tests", "schemas", "data"
)
...
"""
    ...
    with pytest.raises(ValidationError):
        ...
        SpeciesCreate(
            ...
            scaled_projected_frequencies=[500.2 * 0.97, 563.5 * 0.97],
    ...
    with pytest.raises(ValidationError):
        ...
        SpeciesCreate(
            ...
            hessian=[[1] * 15] * 15,
            frequencies=[500.2],
            scaled_projected_frequencies=[500.2 * 0.97],
...
6 H u0 p0 c0 {3,S}"""
    spc_21_xyz = {
        ...
        "coords": (
            (-0.445133, -0.016405, 0.036328),
            (0.840166, -0.566275, -0.329792),
            (1.813794, 0.275863, -0.070634),
            (-0.618754, 0.892203, -0.536074),
            (-1.173511, -0.783026, -0.215793),
            (-0.450682, 0.193222, 1.103747),
        ),
    }
    spc_21_freqs = [
        136.44310609,
    ...
    assert spc_21.torsions[0].trajectory[10] == {
        "coords": (
            (-0.439581, 0.028533, 0.018813),
    ...
    spc_22 = SpeciesCreate(
        ...
        coordinates={
            ...
            "coords": (
                (0.45442697267484206, -0.4438741163520067, -0.8800505426222011),
        ...
        conformers=[
            ...
            },
            {
                ...
                "degeneracy": 2,
                "coords": (
                    (0.8587171131284058, -0.4630746209010718, -0.8426356860390303),
    ...
    assert spc_22.conformers[0]["degeneracy"] == 1
    assert spc_22.conformers[1]["degeneracy"] == 2
    ...
    # 14. paths
    # Not relevant for Species as we have moved it to QCFiles

    # 15. unconverged_jobs, extras
    spc_23 = SpeciesCreate(
        smiles="C",
        charge=0,
        multiplicity=1,
        coordinates=ch4_xyz,
    ...
    #                                     'comment': 'txt',
    #                                     'path': 'path/to/failed/sp/job.log'}]
    assert spc_23.extras == {"key1": "val1", "key2": ["v", "v"]}
