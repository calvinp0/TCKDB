...
def upgrade() -> None:
    ...
    sa.Column('reviewer_flags', MsgpackExt(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'version', 'revision', name='ess_name_version_revision_uc')
    )
    ...
    op.create_index(op.f('ix_reaction_entry_id'), 'reaction_entry', ['id'], unique=False)
    op.create_table('vdw_entry',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('vdw_id', sa.Integer(), nullable=False),
    sa.Column('xyz', MsgpackExt(), nullable=True),
    sa.Column('energy', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['vdw_id'], ['vdw.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['freq_ess_id'], ['ess.id'], ),
    sa.ForeignKeyConstraint(['freq_level_id'], ['level.id'], ),
    sa.ForeignKeyConstraint(['freq_scale_id'], ['freqscale.id'], ),
    sa.ForeignKeyConstraint(['irc_ess_id'], ['ess.id'], ),
    sa.ForeignKeyConstraint(['irc_level_id'], ['level.id'], ),
    ...
    op.create_table('reaction_product',
    sa.Column('reaction_id', sa.Integer(), nullable=False),
    ...
    op.create_table('reaction_reactant',
    sa.Column('reaction_id', sa.Integer(), nullable=False),
    sa.Column('order_index', sa.Integer(), nullable=False),
    sa.Column('species_id', sa.Integer(), nullable=True),
    sa.Column('vdw_id', sa.Integer(), nullable=True),
